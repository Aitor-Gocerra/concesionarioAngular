...
export class CocheService {
  ...
  private listaCoches = [
    ...
    { id: 2, marca: 'Volvo', price: 34789, image: 'https://fotos.quecochemecompro.com/volvo-xc90-hibrido/volvo-xc90-hibrido-trasero.jpg?size=750x400'},
    ...
    { id: 5, marca: 'BMW', price: 55000, image: 'https://img.goodfon.com/wallpaper/big/0/3f/bwm-m2-car-road-speed.webp'},
    { id: 6, marca: 'Tesla', price: 48900, image: 'https://images.unsplash.com/photo-1536700503339-1e4b06520771?auto=format&fit=crop&w=500&q=60'},
    { id: 7, marca: 'Porsche', price: 125000, image: 'https://hips.hearstapps.com/hmg-prod/images/2025-porsche-718-cayman-102-66f6f7f87752d.jpg?crop=0.481xw:0.361xh;0.240xw,0.404xh&resize=980:*'},
    { id: 8, marca: 'Toyota', price: 28500, image: 'https://images.unsplash.com/photo-1590362891991-f776e747a588?auto=format&fit=crop&w=500&q=60'},
    { id: 9, marca: 'Ford', price: 45000, image: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=500&q=60'},
    { id: 10, marca: 'Honda', price: 32000, image: 'https://www.quadisibertecno.es/wp-content/uploads/sites/79/2020/02/Civic-2020-Sport-Line.jpg'}
  ];
